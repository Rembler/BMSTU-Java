...
public class Vector {
    ...
    public int MultiplyBy(Vector vector) throws VectorOperationException {
        EnsureVectorsHaveSameVectorSpaceDimensions(this, vector);
    ...
    public VectorsRelation DefineRelationTo(Vector vector) throws VectorOperationException {
    ...
    private boolean IsCollinearTo(Vector vector) throws VectorOperationException {
        EnsureVectorsHaveSameVectorSpaceDimensions(this, vector);
    ...
    private boolean IsOrthogonalTo(Vector vector) throws VectorOperationException {
        EnsureVectorsHaveSameVectorSpaceDimensions(this, vector);
    ...
    private static void EnsureVectorsHaveSameVectorSpaceDimensions(Vector left, Vector right) throws VectorOperationException {
        if (left.VectorSpaceDimension != right.VectorSpaceDimension) {
            throw new VectorOperationException("Vectors have different vector space dimensions");
        }
    }

    private static Vector CreateVectorFromCoordinates(ArrayList<Integer> resultVectorCoordinates) throws VectorOperationException {
        return switch (resultVectorCoordinates.size()) {
            ...
            default -> throw new VectorOperationException(String.format("Vector space dimension %d is not supported", resultVectorCoordinates.size()));
        };
    }
